...
var protoNew = Stack.prototype;

protoNew.pop = Array.prototype.pop;
protoNew.push = Array.prototype.push;

protoNew.peek = function ( )
{
...
var protoNew = Cell.prototype;

protoNew.toString = function () {
    return "(" + this.car + " . " + this.cdr + ")";
};

protoNew.toLocaleString = function () {
    return "("
...
var protoNew = Nil.prototype = new Cell();
protoNew.constructor = Nil;
...
var protoNew = DiscontinueException.prototype;
protoNew.name = NAMESPACE + ".DiscontinueException";
protoNew.message = "unusual use of `discontinue' (this should be caught by `forEach' or other iteration-methods).";
...
var protoNew = IgnoreException.prototype;
protoNew.name = NAMESPACE + ".IgnoreException";
protoNew.message = "unusual use of `ignore' (this should be caught by `forEach' or other iteration-methods).";
...
var protoNew = ReturnListException.prototype;
protoNew.name = NAMESPACE + ".ReturnListException";
protoNew.message = "unusual use of `return_list' (this should be caught by `forEach' or other iteration-methods).";
...
var protoNew = EndOfLoopException.prototype;
protoNew.name = NAMESPACE + ".EndOfLoopException";
protoNew.message = "this should be caught by `forEach' or other iteration-methods";
...
Function.prototype.extend = function extend ( init, props ) {
    ...
    var protoNew = SubClass.prototype = new null_constructor;
    protoNew.constructor = SubClass;
    protoNew.$super = function ( prop ) {
    ...
    for (var i in props) protoNew[i] = props[i];
...
var protoNew = Enumerable.prototype;
...
protoNew.iterator = function ( ) {
    throw new UnimplementedMethodError("iterator", this);
};


protoNew.forEachNew = function (f) {
    var ret_val;
...
protoNew.and = function () {
    return this.fold(function ( x, y ) {
        return y || discontinue(y);
    }, true);
};

protoNew.or = function () {
    return this.fold(function ( x, y ) {
        return y && discontinue(y);
    }, false);
};

protoNew.all = function ( f ) {
    return this.fold(function ( x, y ) {
        y = f.call(this, y);
        return y || discontinue(y);
    }, true);
...
var protoNew = Iterator.prototype;
...
protoNew.isBoundTo = function ( list ) {
    return false;
};


protoNew.find = function (f) {
...
var protoNew = Collection.prototype = new Enumerable();
protoNew.constructor = Collection;
...
protoNew.add = function ( /* variable args */) {
    throw new UnimplementedMethodError("add", this);
};


protoNew.addAll = function ( /* variable arguments */) {
    var self    = this;
    var changed = false;
...
protoNew.emptyCopy = function ( ) {
    return new this.constructor();
};


protoNew.copy = function ( ) {
...
var protoNew = BidirectionalIterator.prototype = new Iterator();
protoNew.constructor = BidirectionalIterator;
...
var protoNew = Set.prototype = new Collection();
protoNew.constructor = Set;
...
protoNew.contains = function ( /* variable args */) {
    throw new UnimplementedMethodError("contains", this);
};

protoNew.containsAll = function ( /* variable args */) {
    for ( var i=0;  i < arguments.length;  i++ ) {
        var e = arguments[i];
...
protoNew.remove = function ( /* variable args */) {
    throw new UnimplementedMethodError("remove", this);
};

protoNew.removeAll = function ( /* variable args */) {
    var changed = false;
    for ( var i=0;  i < arguments.length;  i++ ) {
        var e = arguments[i];
        if ( e instanceof Array ) {
...
protoNew.retainAll = function ( /* variable args */ ) {
...
var protoNew = List.prototype = new Collection();
protoNew.constructor = List;
...
protoNew.iterator = function ( /* delegate */) {
...
protoNew.insertAt = function (it, v) {
    if ( !(it instanceof List.Iterator  &&  it.isBoundTo(this)) ) {
        it = this.head(it);
    }
    return it.insert(v);
...
protoNew.pop = function ( ) {
    return this.reverseHead().remove();
};

protoNew.push = function ( /* variable args */ ) {
    this.add.apply(this, arguments);
    return this.size();
};

protoNew.shift = function () {
    return this.head().remove();
};

protoNew.unshift = function ( /* variable args */) {
...
protoNew.join = function ( /* delegate */) {
    var arr = this.toArray();
    return arr.join.apply(arr, arguments);
};

protoNew.toString = function ( /* delegate */) {
    var arr = this.toArray();
    return arr.toString.apply(arr, arguments);
};

protoNew.toLocaleString = function ( /* delegate */) {
    var arr = this.toArray();
    return arr.toLocaleString.apply(arr, arguments);
};


protoNew.reverse = function ( ) {
...
protoNew.slice = function (start, end) {
...
protoNew.concat = function ( /* variable arguments */) {
...
protoNew.foldl = protoNew.fold;

protoNew.foldl1 = protoNew.fold1;

protoNew.foldr = function (f, s) {
...
var protoNew = Iterator.prototype = new BidirectionalIterator();
protoNew.constructor = Iterator;
...
protoNew.distance =
protoNew.compareTo = function ( that ) {
...
var protoNew = ReverseIterator.prototype = new Iterator();
protoNew.constructor = ReverseIterator;


protoNew.isBoundTo = function ( that ) {
...
protoNew.distance = function (that) {
    if ( !(that instanceof ReverseIterator) ) return undefined;
...
var protoNew = new List();
protoNew.toString       = Cell.prototype.toString;
protoNew.toLocaleString = Cell.prototype.toLocaleString;
protoNew.isNil          = Cell.prototype.isNil;
Cell.prototype = protoNew;
protoNew.constructor = Cell;

protoNew = new Cell();
protoNew.toString = Nil.prototype.toString;
protoNew.toLocaleString = Nil.prototype.toLocaleString;
protoNew.isNil          = Nil.prototype.isNil;
Nil.prototype = protoNew;
protoNew.constructor = Nil;
...
protoNew.concat = function ( /* variable args */) {
    var head, cell;
    head = cell = new Cell(null, new Nil());
    arguments[-1] = this;
    for ( var i=-1;  i < arguments.length;  i++ ) {
...
var protoNew = Iterator.prototype = new List.Iterator();
protoNew.constructor = Iterator;
...
var protoNew = ReverseIterator.prototype = new List.ReverseIterator();
protoNew.constructor = ReverseIterator;
...
var protoNew = Array.prototype;

for ( var i in List.prototype ) {
    if (typeof protoNew[i] != "function") protoNew[i] = List.prototype[i];
}
...
protoNew.iterator = protoNew.head;
...
var original_concat = protoNew.concat;
protoNew.concat = function ( /* variable argumentes */ ) {
    for ( var i=0;  i < arguments.length;  i++ ) {
        var v = arguments[i];
...
var original_slice = protoNew.slice;
protoNew.slice = function ( start, end ) {
    if (   (   start instanceof Iterator        && end instanceof Iterator
            || start instanceof ReverseIterator && end instanceof ReverseIterator )
        && start.isBoundTo(this) && end.isBoundTo(this)  )
...
var protoNew = LinkedList.prototype = new List();
protoNew.constructor = LinkedList;
...
protoNew.unshift = function ( /* variable arguments */ ) {
...
var protoNew = ReverseIterator.prototype = new List.Iterator();
for (var i in Iterator.prototype) protoNew[i] = Iterator.prototype[i];
protoNew.constructor = ReverseIterator;
...
protoNew.isBoundTo = Iterator.prototype.isBoundTo;
...
protoNew.assign = Iterator.prototype.assign;
...
protoNew.remove = Iterator.prototype.remove;
...
var protoNew = THREAD.prototype = Thread.prototype;
...
var protoNew = Function.prototype;

protoNew.apply.$Concurrent_Thread_compiled = function ( this_val, args, cont ) {
...
protoNew.call.$Concurrent_Thread_compiled = function ( this_val, args, cont ) {
    if ( typeof this_val.$Concurrent_Thread_compiled == "function" ) {
...
protoNew.async = function (this_val, args) {
...
var protoNew = IdentifierSet.prototype = new Set();
protoNew.constructor = IdentifierSet;


var hasOwnProperty = Object.prototype.hasOwnProperty;

protoNew.contains = function ( /* variable arguments */) {
    for ( var i=0;  i < arguments.length;  i++ ) {
        var id = arguments[i];
...
protoNew.add = function ( /* variable arguments */) {
    var changed = false;
    for ( var i=0;  i < arguments.length;  i++ ) {
        var id = arguments[i];
        if ( !(id instanceof Identifier) ) throw new TypeError("arguments[" + i + "] is not of type Identifier");
...
protoNew.remove = function ( /* variable arguments */) {
    var changed = false;
    for ( var i=0;  i < arguments.length;  i++ ) {
        var id = arguments[i];
...
var protoNew = IdIterator.prototype = new Iterator();
protoNew.constructor = IdIterator;

protoNew.isBoundTo = function ( o ) {
...
var protoNew = ErrorReporter.prototype;
 ...
 */
protoNew.warning = function (message, line, lineSource, lineOffset) { };
 ...
 * @param lineOffset the offset into lineSource where problem was detected
 */
protoNew.error = function (message, line, lineSource, lineOffset) { };
...
var protoNew = Mutex.prototype;


protoNew.isAcquirable = function ( ) {
    return !this._acquiring  &&  this._waiting.isEmpty();
};


protoNew.acquire = function ( ) {
    throw new Error("can't `acquire' in non-converted function");
};

protoNew.acquire.$Concurrent_Thread_compiled = function ( $this, $args, $cont ) {
...
var protoNew = UnaryExpression.prototype = new Expression();
protoNew.constructor = UnaryExpression;
...
var protoNew = BinaryExpression.prototype = new Expression();
protoNew.constructor = BinaryExpression;
...
var protoNew = ThisExpression.prototype = new Expression();
protoNew.constructor = ThisExpression;
...
var protoNew = Identifier.prototype = new Expression();
protoNew.constructor = Identifier;

protoNew.toString = function () {
    return this.string;
};

protoNew.valueOf = function ( ) {
    return this.value;
};
...
var protoNew = Literal.prototype = new Expression();
protoNew.constructor = Literal;
...
var protoNew = NumberLiteral.prototype = new Literal();
protoNew.constructor = NumberLiteral;
...
var protoNew = StringLiteral.prototype = new Literal();
protoNew.constructor = StringLiteral;
...
var protoNew = RegExpLiteral.prototype = new Literal();
protoNew.constructor = RegExpLiteral;
...
var protoNew = NullLiteral.prototype = new Literal();
protoNew.constructor = NullLiteral;

protoNew.string = "null";
protoNew.vakue = null;
...
var protoNew = BooleanLiteral.prototype = new Literal();
protoNew.constructor = BooleanLiteral;
...
var protoNew = TrueLiteral.prototype = new BooleanLiteral();
protoNew.constructor = TrueLiteral;

protoNew.string = "true";
protoNew.vakue = true;
...
var protoNew = FalseLiteral.prototype = new BooleanLiteral();
protoNew.constructor = FalseLiteral;

protoNew.string = "false";
protoNew.vakue = false;
...
var protoNew = ArrayInitializer.prototype = new Expression();
protoNew.constructor = ArrayInitializer;
...
protoNew.hasSideEfect = function () {
    for ( var i=0;  i < this.elems.length;  i++ ) {
...
var protoNew = Elision.prototype = new Expression();
protoNew.constructor = Elision;
...
var protoNew = ObjectInitializer.prototype = new Expression();
protoNew.constructor = ObjectInitializer;
...
var protoNew = FunctionExpression.prototype = new Expression();
protoNew.constructor = FunctionExpression;

protoNew.toString = function () {
    var buf = ["(function "];
    if ( this.name ) buf.push(this.name);
    buf.push( "(", this.params.join(", "), ") {\n");
    this.body.forEachNew(function( it ){
        buf.push(it, "\n");
    });
    buf.push("})");
    return buf.join("");
...
var protoNew = DotAccessor.prototype = new Expression();
protoNew.constructor = DotAccessor;
...
var protoNew = BracketAccessor.prototype = new BinaryExpression();
protoNew.constructor = BracketAccessor;
...
var protoNew = NewExpression.prototype = new Expression();
protoNew.constructor = NewExpression;
...
var protoNew = CallExpression.prototype = new Expression();
protoNew.constructor = CallExpression;
...
var protoNew = PostIncExpression.prototype = new UnaryExpression();
protoNew.constructor = PostIncExpression;
...
var protoNew = PostDecExpression.prototype = new UnaryExpression();
protoNew.constructor = PostDecExpression;
...
var protoNew = PreIncExpression.prototype = new UnaryExpression();
protoNew.constructor = PreIncExpression;
...
var protoNew = PreDecExpression.prototype = new UnaryExpression();
protoNew.constructor = PreDecExpression;
...
var protoNew = DeleteExpression.prototype = new UnaryExpression();
protoNew.constructor = DeleteExpression;
...
var protoNew = VoidExpression.prototype = new UnaryExpression();
protoNew.constructor = VoidExpression;
...
var protoNew = TypeofExpression.prototype = new UnaryExpression();
protoNew.constructor = TypeofExpression;
...
var protoNew = PosExpression.prototype = new UnaryExpression();
protoNew.constructor = PosExpression;
...
var protoNew = NegExpression.prototype = new UnaryExpression();
protoNew.constructor = NegExpression;
...
var protoNew = BitNotExpression.prototype = new UnaryExpression();
protoNew.constructor = BitNotExpression;
...
var protoNew = NotExpression.prototype = new UnaryExpression();
protoNew.constructor = NotExpression;
...
var protoNew = MulExpression.prototype = new BinaryExpression();
protoNew.constructor = MulExpression;
...
var protoNew = DivExpression.prototype = new BinaryExpression();
protoNew.constructor = DivExpression;
...
var protoNew = ModExpression.prototype = new BinaryExpression();
protoNew.constructor = ModExpression;
...
var protoNew = AddExpression.prototype = new BinaryExpression();
protoNew.constructor = AddExpression;
...
var protoNew = SubExpression.prototype = new BinaryExpression();
protoNew.constructor = SubExpression;
...
var protoNew = LShiftExpression.prototype = new BinaryExpression();
protoNew.constructor = LShiftExpression;
...
var protoNew = RShiftExpression.prototype = new BinaryExpression();
protoNew.constructor = RShiftExpression;
...
var protoNew = URShiftExpression.prototype = new BinaryExpression();
protoNew.constructor = URShiftExpression;
...
var protoNew = LessThanExpression.prototype = new BinaryExpression();
protoNew.constructor = LessThanExpression;
...
var protoNew = GreaterThanExpression.prototype = new BinaryExpression();
protoNew.constructor = GreaterThanExpression;
...
var protoNew = LessEqualExpression.prototype = new BinaryExpression();
protoNew.constructor = LessEqualExpression;
...
var protoNew = GreaterEqualExpression.prototype = new BinaryExpression();
protoNew.constructor = GreaterEqualExpression;
...
var protoNew = InstanceofExpression.prototype = new BinaryExpression();
protoNew.constructor = InstanceofExpression;
...
var protoNew = InExpression.prototype = new BinaryExpression();
protoNew.constructor = InExpression;
...
var protoNew = EqualExpression.prototype = new BinaryExpression();
protoNew.constructor = EqualExpression;
...
var protoNew = NotEqualExpression.prototype = new BinaryExpression();
protoNew.constructor = NotEqualExpression;
...
var protoNew = StrictEqualExpression.prototype = new BinaryExpression();
protoNew.constructor = StrictEqualExpression;
...
var protoNew = StrictNotEqualExpression.prototype = new BinaryExpression();
protoNew.constructor = StrictNotEqualExpression;
...
var protoNew = BitAndExpression.prototype = new BinaryExpression();
protoNew.constructor = BitAndExpression;
...
var protoNew = BitXorExpression.prototype = new BinaryExpression();
protoNew.constructor = BitXorExpression;
...
var protoNew = BitOrExpression.prototype = new BinaryExpression();
protoNew.constructor = BitOrExpression;
...
var protoNew = AndExpression.prototype = new BinaryExpression();
protoNew.constructor = AndExpression;
...
var protoNew = OrExpression.prototype = new BinaryExpression();
protoNew.constructor = OrExpression;
...
var protoNew = ConditionalExpression.prototype = new Expression();
protoNew.constructor = ConditionalExpression;
...
var protoNew = AssignExpression.prototype = new BinaryExpression();
protoNew.constructor = AssignExpression;
...
var protoNew = SimpleAssignExpression.prototype = new AssignExpression();
protoNew.constructor = SimpleAssignExpression;
...
var protoNew = MulAssignExpression.prototype = new AssignExpression();
protoNew.constructor = MulAssignExpression;
...
var protoNew = DivAssignExpression.prototype = new AssignExpression();
protoNew.constructor = DivAssignExpression;
...
var protoNew = ModAssignExpression.prototype = new AssignExpression();
protoNew.constructor = ModAssignExpression;
...
var protoNew = AddAssignExpression.prototype = new AssignExpression();
protoNew.constructor = AddAssignExpression;
...
var protoNew = SubAssignExpression.prototype = new AssignExpression();
protoNew.constructor = SubAssignExpression;
...
var protoNew = LShiftAssignExpression.prototype = new AssignExpression();
protoNew.constructor = LShiftAssignExpression;
...
var protoNew = RShiftAssignExpression.prototype = new AssignExpression();
protoNew.constructor = RShiftAssignExpression;
...
var protoNew = URShiftAssignExpression.prototype = new AssignExpression();
protoNew.constructor = URShiftAssignExpression;
...
var protoNew = BitAndAssignExpression.prototype = new AssignExpression();
protoNew.constructor = BitAndAssignExpression;
...
var protoNew = BitXorAssignExpression.prototype = new AssignExpression();
protoNew.constructor = BitXorAssignExpression;
...
var protoNew = BitOrAssignExpression.prototype = new AssignExpression();
protoNew.constructor = BitOrAssignExpression;
...
var protoNew = CommaExpression.prototype = new BinaryExpression();
protoNew.constructor = CommaExpression;
...
var protoNew = EmptyStatement.prototype = new Statement();
protoNew.constructor = EmptyStatement;
...
var protoNew = Block.prototype = new Statement();
protoNew.constructor = Block;
...
var protoNew = ExpStatement.prototype = new Statement();
protoNew.constructor = ExpStatement;
...
var protoNew = VarStatement.prototype = new Statement();
protoNew.constructor = VarStatement;
...
var protoNew = IfStatement.prototype = new Statement();
protoNew.constructor = IfStatement;
...
var protoNew = IfElseStatement.prototype = new Statement();
protoNew.constructor = IfElseStatement;
...
var protoNew = DoWhileStatement.prototype = new Statement();
protoNew.constructor = DoWhileStatement;
...
var protoNew = WhileStatement.prototype = new Statement();
protoNew.constructor = WhileStatement;
...
var protoNew = ForStatement.prototype = new Statement();
protoNew.constructor = ForStatement;
...
var protoNew = ForVarStatement.prototype = new Statement();
protoNew.constructor = ForVarStatement;
...
var protoNew = ForInStatement.prototype = new Statement();
protoNew.constructor = ForInStatement;
...
var protoNew = ForInVarStatement.prototype = new Statement();
protoNew.constructor = ForInVarStatement;
...
var protoNew = ForEachStatement.prototype = new Statement();
protoNew.constructor = ForEachStatement;
...
var protoNew = ForEachVarStatement.prototype = new Statement();
protoNew.constructor = ForEachVarStatement;
...
var protoNew = ContinueStatement.prototype = new Statement();
protoNew.constructor = ContinueStatement;
...
var protoNew = BreakStatement.prototype = new Statement();
protoNew.constructor = BreakStatement;
...
var protoNew = ReturnStatement.prototype = new Statement();
protoNew.constructor = ReturnStatement;
...
var protoNew = WithStatement.prototype = new Statement();
protoNew.constructor = WithStatement;
...
var protoNew = SwitchStatement.prototype = new Statement();
protoNew.constructor = SwitchStatement;
...
var protoNew = ThrowStatement.prototype = new Statement();
protoNew.constructor = ThrowStatement;
...
var protoNew = TryCatchStatement.prototype = new Statement();
protoNew.constructor = TryCatchStatement;
...
var protoNew = TryFinallyStatement.prototype = new Statement();
protoNew.constructor = TryFinallyStatement;
...
var protoNew = TryCatchFinallyStatement.prototype = new Statement();
protoNew.constructor = TryCatchFinallyStatement;
...
var protoNew = TryCatchListStatement.prototype = new Statement();
protoNew.constructor = TryCatchListStatement;

protoNew.toString = function () {
    var buf = [ labelsToString.call(this),
                "try ", this.tryBlock, "\n" ];
    this.catchList.forEachNew(function( it ){
        buf.push(it);
    });
    return buf.join("");
};
...
var protoNew = TryCatchListFinallyStatement.prototype = new Statement();
protoNew.constructor = TryCatchListFinallyStatement;
...
var protoNew = FunctionDeclaration.prototype = new Statement();
protoNew.constructor = FunctionDeclaration;
...
var protoNew = IdentifierMap.prototype;


protoNew.clone = function clone() {
...
protoNew.exists = function ( /* variable arguments */) {
    for ( var i=0;  i < arguments.length;  i++ ) {
        var key = arguments[i];
...
protoNew.put = function (k, v) {
    if ( !(k instanceof Identifier) ) throw new TypeError("arguments[0] is not of type Identifier");
    this._map[k.valueOf()] = {id: k, value: v};
};


protoNew.remove = function ( k ) {
    if ( !(k instanceof Identifier) ) throw new TypeError("arguments[0] is not of type Identifier");
    return delete this._map[k.valueOf()];
};


protoNew.keys = function () {
...
var protoNew = TokenStream.prototype;
 ...
 */
protoNew.tokenToString = function ( token )
{
    if (Token.printTrees) {
...
protoNew.getLineno = function () { return this.lineno; };

protoNew.getString = function () { return this.string; };

protoNew.eof = function ( ) { return this.hitEOF; };


protoNew.getToken = function ()
{
    var c;
 ...
 */
protoNew.readRegExp = function (startToken)
{
...
protoNew.isXMLAttribute = function ()
{
    return this.xmlIsAttribute;
};

protoNew.getFirstXMLToken = function ()
{
    this.xmlOpenTagsCount = 0;
    this.xmlIsAttribute   = false;
    this.xmlIsTagContent  = false;
...
protoNew.getNextXMLToken = function ()
{
...
protoNew.readQuotedString = function (quote)
{
    for ( var c=this.getChar();  c !== EOF_CHAR;  c=this.getChar() ) {
        this.addToString(c);
...
protoNew.readXmlComment = function ( )
{
...
protoNew.getStringFromBuffer = function ()
{
    return this.stringBuffer.join("");
};

protoNew.addToString = function ( /* variable arguments */ )
{
    this.stringBuffer.push.apply(this.stringBuffer, arguments);
};

protoNew.ungetChar = function ( c )
{
...
protoNew.matchChar = function (test)
{
    var c = this.getChar();
    if ( c === test ) {
        return true;
...
var protoNew = Block.prototype;

protoNew.toString = function () {
    Kit.codeBug('"toString" is not implemented for ', this.constructor);
};

protoNew.appendStatement = function ( /* variable arguments */) {
    var args = arguments;
    if ( this.body.isNil() ) {
...
protoNew.prependStatement = function ( /* variable arguments */) {
    for ( var i=arguments.length-1;  i >= 0;  i-- ) {
...
var protoNew = GotoBlock.prototype = new Block();

protoNew.constructor = GotoBlock;
...
var protoNew = CallBlock.prototype = new Block();

protoNew.constructor = CallBlock;
...
var protoNew = NewBlock.prototype = new Block();

protoNew.constructor = NewBlock;
...
var protoNew = CondStatement.prototype = new Statement();

protoNew.constructor = CondStatement;
...
var protoNew = RecvStatement.prototype = new Statement();

protoNew.constructor = RecvStatement;
...
var protoNew = EnumStatement.prototype = new Statement();

protoNew.constructor = EnumStatement;
...
var protoNew = Parser.prototype;


protoNew.getMessage = function ( messageId  /* optional args */ )
{
    //!! fake implementation
    return messageId;
};

protoNew.addWarning = function (messageId  /* optional args */)
{
...
protoNew.addError = function (messageId  /* optional args */)
{
...
protoNew.reportError = function (messageId  /* optional args */)
{
...
protoNew.peekFlaggedToken = function ()
{
    this.peekToken();
    return this.flaggedTokenBuffer.peek();
};

protoNew.consumeToken = function ()
{
    this.flaggedTokenBuffer.pop();
};

protoNew.nextToken = function ()
{
...
protoNew.nextFlaggedToken = function ()
{
    this.peekToken();
...
protoNew.matchToken = function (toMatch)
{
...
protoNew.peekTokenOrEOL = function ()
{
    var tt = this.peekToken();
...
// in switch-statement.
protoNew.ungetToken = function (token)
{
    this.flaggedTokenBuffer.push(token);
};

protoNew.setCheckForLabel = function ()
{
...
protoNew.mustMatchToken = function (toMatch, messageId  /* optional args */)
{
...
protoNew.eof = function ()
{
    return this.ts.eof();
};

protoNew.insideFunction = function ()
{
    return this.nestingOfFunction !== 0;
};

protoNew.insideLoop = function ()
{
    return this.nestingOfLoop !== 0;
};

protoNew.enterLoop = function (labels)
{
    for ( var i=0;  i < labels.length;  i++ ) this.loopLabelSet.add(labels[i]);
    this.nestingOfLoop++;
};

protoNew.exitLoop = function ( labels )
{
...
protoNew.parse = function (sourceString, lineno, source)
{
...
protoNew.functionDecl = function (labels)
{
...
protoNew.functionExpr = function ( )
{
    var name = null;
...
protoNew.parameterList = function ()
{
...
protoNew.functionBody = function ()
{
...
protoNew.statementHelper = function (labels)
{
    var statement = null;
    switch ( this.peekToken() ) {
      case Token.IF: {
...
protoNew.matchJumpLabelName = function (token)
{
...
protoNew.statementsInSwitch = function ()
{
    var head, cell;
...
protoNew.variables = function (inForInit)
{
    var decls = [];
    for (;;) {
...
protoNew.expr = function (inForInit)
{
...
protoNew.assignExpr = function ( inForInit )
{
...
protoNew.condExpr = function (inForInit)
{
...
protoNew.orExpr = function (inForInit)
{
...
protoNew.andExpr = function (inForInit)
{
...
protoNew.bitOrExpr = function ( inForInit )
{
...
protoNew.bitXorExpr = function (inForInit)
{
...
protoNew.bitAndExpr = function (inForInit)
{
...
protoNew.eqExpr = function (inForInit)
{
...
protoNew.relExpr = function (inForInit)
{
...
protoNew.argumentList = function ()
{
    if ( this.matchToken(Token.RP) ) return [];
    var args = [];
    do {
...
protoNew.memberExpr = function (allowCallSyntax)
{
    var base;
...
protoNew.memberExprTail = function (allowCallSyntax, base)
{
    tailLoop: for (;;) {
        switch ( this.peekToken() ) {
          case Token.DOTDOT:
...
function check_cyclic ( depends ) {
    ...
    var result = [];
    depends.keys().forEachNew(function( it ){
        var path = [];
        traverse(it, path);
...
var protoNew = Context.prototype;

protoNew.getStackVar = function ( n ) {
    n = Math.floor(n);
...
protoNew.putBreakLabels = function ( labels, target ) {
...
protoNew.putBreakAndContinueLabels = function ( labels, breakTarget, continueTarget ) {
    if ( !labels.length ) {
        return {
...
protoNew.getScopes = function () {
    return this.scopes.slice(0, this.scopes.length);
};

protoNew.pushScope = function ( /* variable args */) {
    return this.scopes.push.apply(this.scopes, arguments);
};

protoNew.popScope = function () {
    return this.scopes.pop();
};

protoNew.makeGotoBlock = function (arg, target) {
...
TryFinallyStatement.prototype[Cs] = function ( follows, ctxt, sttop ) {
    ...
    try {
        ...
        ctxt.contBreak.keys().forEachNew(function( label ){
        ...
        ctxt.contContinue.keys().forEachNew(function( label ){
...
var protoNew = Generator.prototype;


protoNew.hasNext = function ( ) {
...
protoNew.hasNext.$Concurrent_Thread_compiled = eval(Thread.prepare(
    function ( ) {
        this._mutex.acquire();
        try {
            if ( this._got        ) return true;
...
protoNew.next = eval(Thread.prepare(
    function ( ) {
        if ( this.hasNext() ) {
            var x = this._buf;
            this._buf = void 0;
