<template lang="html" class='sss'>
    ...
    <Layout>
      <Header>
        <IndexHeader @showCharts = 'isShow = !isShow' />
      </Header>
      <Content>
        ...
        <div class="box">
         ...
         <!-- <Scroll :on-reach-bottom="handleReachBottom"> -->
                <Table :row-class-name="rowClassName" :columns="indexColumns" :data="indexData">
        ...
        switch1(){
            ...
            if(this.switch1){
                this.timer = setInterval(function(){
                    _this.getData()
                    _this.$refs.myCharts.getDataArr();
                }, 5000)
            } else {
